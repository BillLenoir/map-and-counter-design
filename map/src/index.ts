...
const hexWidth = flatSpacingIn * dpi; // 1 inch flat-to-flat
const hexRadius = hexWidth / 2;
const hexHeight = Math.sqrt(3) * hexRadius; // point-to-point vertical height
...
function generateHexGridSVG(): string {
  ...
  boundaries.forEach(([x1, y1, x2, y2]) => {
